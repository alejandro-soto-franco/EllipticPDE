...
(`EllipticDirichlet.Regularity.diffQuot`) through the extension-by-zero bridge
...
(`EllipticDirichlet.Regularity.cutoffMul`), by conjugating the coordinatewise pi-map with
